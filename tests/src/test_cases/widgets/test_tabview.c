...
static lv_obj_t * test_tabview_active_screen = NULL;
static lv_obj_t * _test_tabview = NULL;

void setUp(void)
{
    test_tabview_active_screen = lv_screen_active();
}

void tearDown(void)
{
    lv_obj_clean(test_tabview_active_screen);
}

void test_tabview_create_successful_dir_top(void)
{
    _test_tabview = lv_tabview_create(test_tabview_active_screen);
    lv_tabview_set_tab_bar_size(_test_tabview, 50);

    TEST_ASSERT_NOT_NULL(_test_tabview);
...
{
    _test_tabview = lv_tabview_create(test_tabview_active_screen);
    lv_tabview_set_tab_bar_position(_test_tabview, LV_DIR_BOTTOM);
    lv_tabview_set_tab_bar_size(_test_tabview, 50);
...
{
    _test_tabview = lv_tabview_create(test_tabview_active_screen);
    lv_tabview_set_tab_bar_position(_test_tabview, LV_DIR_LEFT);
    lv_tabview_set_tab_bar_size(_test_tabview, 50);
...
{
    _test_tabview = lv_tabview_create(test_tabview_active_screen);
    lv_tabview_set_tab_bar_position(_test_tabview, LV_DIR_RIGHT);
    lv_tabview_set_tab_bar_size(_test_tabview, 50);
...
{
    _test_tabview = lv_tabview_create(test_tabview_active_screen);
    lv_tabview_set_tab_bar_position(_test_tabview, LV_DIR_TOP);
    lv_tabview_set_tab_bar_size(_test_tabview, 50);

    lv_obj_t * tab1 = lv_tabview_add_tab(_test_tabview, "Tab 1");
...
void test_tabview_add_several_tabs_no_scroll(void)
{
    ...
    lv_obj_t * tab1 = lv_tabview_add_tab(_test_tabview, "Tab 1");
    lv_obj_t * tab2 = lv_tabview_add_tab(_test_tabview, "Tab 2");
    lv_obj_t * tab3 = lv_tabview_add_tab(_test_tabview, "Tab 3");
...
void test_tabview_rename_tab(void)
{
    ...
    lv_tabview_rename_tab(_test_tabview, 1, "2nd Tab");
...
void test_tabview_get_content(void)
{
    ...
    lv_obj_t * content = lv_tabview_get_content(_test_tabview);
...
void test_tabview_get_tab_bar(void)
{
    ...
    lv_obj_t * tab_bar = lv_tabview_get_tab_bar(_test_tabview);
...
void test_tabview_set_act_non_existent(void)
{
    ...
    lv_tabview_set_active(_test_tabview, 1, LV_ANIM_ON);
...
void test_tabview_tab2_selected_event(void)
{
    ...
    lv_tabview_set_active(_test_tabview, 1, LV_ANIM_OFF);

    TEST_ASSERT_EQUAL_UINT16(1, lv_tabview_get_tab_active(_test_tabview));
}
...
void test_tabview_update_on_external_scroll(void)
{
    ...
    lv_obj_t * tab2 = lv_tabview_add_tab(_test_tabview, "Tab 2");
    lv_obj_t * tab3 = lv_tabview_add_tab(_test_tabview, "Tab 3");
    lv_obj_t * tab4 = lv_tabview_add_tab(_test_tabview, "Tab 4");
    ...
    TEST_ASSERT_EQUAL_UINT16(2, lv_tabview_get_tab_active(_test_tabview));
}
