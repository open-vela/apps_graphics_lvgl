...
void test_canvas_buffer_operations(void)
{
    ...
    static LV_ATTRIBUTE_MEM_ALIGN uint8_t buf[_LV_DRAW_BUF_SIZE(100, 50, LV_COLOR_FORMAT_RGB565)];
...
void test_canvas_fill_background_formats(void)
{
    ...
    LV_DRAW_BUF_DEFINE_STATIC(draw_buf_unsupported, 10, 10, LV_COLOR_FORMAT_L8);
