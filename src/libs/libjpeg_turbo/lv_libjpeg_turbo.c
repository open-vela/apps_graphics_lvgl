...
typedef enum {
    ...
    IMAGE_CLOCKWISE_0       = 1, /* Orientation = 1 is created when Oth row of the coded image data stored in the Exif image file and the visual top of the display screen,
                                  * and Oth column and visual left, will each be matched for display */
    IMAGE_FLIP_HOR          = 2, /* Orientation = 2 is equivalent to an arrangement that is reversed Orrientation = 1 horizontally */
    IMAGE_CLOCKWISE_180     = 3, /* Orientation = 3 is equivalent to an arrangement that is turned Orientation = 6 90 degrees clockwise */
    IMAGE_FLIP_VER          = 4, /* Orientation = 4 is equivalent to an arrangement that is reversed Orientation = 3 horizontally */
    IMAGE_TRANSPOSE         = 5, /* Orientation = 5 is equivalent to an arrangement that is reversed Orientation = 6 horizontally */
    IMAGE_CLOCKWISE_90      = 6, /* Orientation = 6 is equivalent to an arrangement that is turned Orientation = 1 90 degrees clockwise */
    IMAGE_TRANSVERSE        = 7, /* Orientation = 7 is equivalent to an arrangement that is reversed Orientation = 8 horizontally */
    IMAGE_CLOCKWISE_270     = 8, /* Orientation = 8 is equivalent to an arrangement that is turned Orientation = 3 90 degrees clockwise */
} image_orientation_t;
...
static lv_draw_buf_t * decode_jpeg_file(const char * filename, lv_image_decoder_args_t * args)
{
    ...
    /**
     * decode jpeg data to lv_draw_buf_t
     */
