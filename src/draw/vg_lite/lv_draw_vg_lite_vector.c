                        ...
                        const lv_opa_t opa)
{
    ...
    lv_vg_lite_path_t * lv_vg_stroke_path = lv_vg_lite_stroke_path_get(u, path, &dsc->stroke_dsc);
    ...
    const vg_lite_color_t vg_color = lv_color32_to_vg(dsc->stroke_dsc.color, OPA_MIX(dsc->stroke_dsc.opa, opa));
