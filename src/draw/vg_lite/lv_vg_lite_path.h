...
* So we use FLT_MAX and -FLT_MAX to write the mark to bounding_box to tell vg_lite_tvg not to add clip path to the current path.
*/
#define PATH_COORD_MAX FLT_MAX
#define PATH_COORD_MIN -FLT_MAX
#else
