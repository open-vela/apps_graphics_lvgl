...
#if (LV_USE_VECTOR_GRAPHIC || LV_USE_VECTOR_GRAPHIC_OPTIMIZE) && LV_USE_THORVG && !LV_USE_VG_LITE_THORVG
...
static void execute_drawing(lv_draw_sw_unit_t * u)
{
    ...
    switch(t->type) {
        ...
        case LV_DRAW_TASK_TYPE_MASK_RECTANGLE:
            ...
            break;
#if (LV_USE_VECTOR_GRAPHIC || LV_USE_VECTOR_GRAPHIC_OPTIMIZE) && (LV_USE_THORVG_EXTERNAL || LV_USE_THORVG_INTERNAL) && !LV_USE_VG_LITE_THORVG
