...
/* Use SiFli EPIC draw accelerator. */
#ifndef LV_USE_DRAW_SIFLI_EPIC
    #ifdef CONFIG_LV_USE_DRAW_SIFLI_EPIC
        #define LV_USE_DRAW_SIFLI_EPIC CONFIG_LV_USE_DRAW_SIFLI_EPIC
    #else
    ...
    #ifndef LV_USE_DRAW_SIFLI_EPIC_DRAW_THREAD
        #ifdef CONFIG_LV_USE_DRAW_SIFLI_EPIC_DRAW_THREAD
            #define LV_USE_DRAW_SIFLI_EPIC_DRAW_THREAD CONFIG_LV_USE_DRAW_SIFLI_EPIC_DRAW_THREAD
        #else
            #define LV_USE_DRAW_SIFLI_EPIC_DRAW_THREAD 0
        #endif
    #endif

    #ifndef LV_USE_DRAW_SIFLI_EPIC_ASSERT
        #ifdef CONFIG_LV_USE_DRAW_SIFLI_EPIC_ASSERT
            #define LV_USE_DRAW_SIFLI_EPIC_ASSERT CONFIG_LV_USE_DRAW_SIFLI_EPIC_ASSERT
        #else
            #define LV_USE_DRAW_SIFLI_EPIC_ASSERT 0
        #endif
    #endif
#endif
